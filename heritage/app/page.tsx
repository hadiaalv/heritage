        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl animate-fade-in-up">
              Welcome to <span className="text-blue-600">Heritage</span>
            </h1>
            <p className="mt-6 text-lg leading-8 text-gray-600 animate-fade-in-up animation-delay-200">
              Preserving tradition, embracing innovation. Building a legacy that lasts.
            </p>
      ...
      <section className="py-20 bg-white">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-lg leading-8 text-gray-600 animate-fade-in animation-delay-200">
              We combine decades of experience with modern approaches to deliver exceptional results.
            </p>
          </div>
          <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
            <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
              <div className="flex flex-col items-center text-center animate-fade-in-up animation-delay-200">
                ...
                <dt className="text-base font-semibold leading-7 text-gray-900">Timeless Values</dt>
                <dd className="mt-1 text-base leading-7 text-gray-600">
                  We uphold the principles that have guided us for generations.
                </dd>
              </div>
              <div className="flex flex-col items-center text-center animate-fade-in-up animation-delay-400">
                ...
                <dd className="mt-1 text-base leading-7 text-gray-600">
                  We embrace new technologies and methodologies to stay ahead.
                </dd>
              </div>
              <div className="flex flex-col items-center text-center animate-fade-in-up animation-delay-400">
                <div className="mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-blue-100">
                ...
                <dt className="text-base font-semibold leading-7 text-gray-900">Community</dt>
                <dd className="mt-1 text-base leading-7 text-gray-600">
                  We are committed to serving and strengthening our community.
                </dd>
              </div>
            </dl>
          </div>
